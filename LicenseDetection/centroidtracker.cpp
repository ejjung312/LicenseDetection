...
*/
std::vector<std::pair<int, std::pair<int, int>>> CentroidTracker::update(DetectionResult* boxes, int* resultCount) {
    if (resultCount == 0) { // 검출 결과가 없을 경우
